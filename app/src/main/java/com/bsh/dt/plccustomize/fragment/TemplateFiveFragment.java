...
public class TemplateFiveFragment extends BaseFragment {
    ...
    public int getLayoutId() {
        ...
        if (size == Constant.LARGE) {
            id = R.layout.layout_six_items_one;

        } else if (size == Constant.SMALL) {
            id = R.layout.layout_six_items_one_small;
        }
        return id;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ivProgram6.setImageResource(program6.getPictureHorizontal());
        return view;
    }
