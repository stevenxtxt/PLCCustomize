...
public class TemplateOneFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ivProgram5.setImageResource(program5.getPictureVertical());
        return view;
    }
    ...
    public int getLayoutId() {
        ...
        if (size == Constant.LARGE) {
            id = R.layout.layout_five_items_one;

        } else if (size == Constant.SMALL) {
            id = R.layout.layout_five_items_one_small;
        }
        return id;
    }
